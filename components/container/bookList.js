        ...
        return (
            <Fragment>
                {renderBookListData.results.map(book => (
                    <li
                        key={book.id}
                        className='h-min md:h-52 md:w-3/4 border-1 border-slate-400 rounded-sm md:rounded-md mx-auto my-4 md:my-5 drop-shadow-xl md:drop-shadow-3xl shadow-lg list-none'
                    >
